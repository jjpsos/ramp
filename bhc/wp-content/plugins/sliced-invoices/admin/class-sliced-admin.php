...
class Sliced_Admin {
	...
	public function admin_footer_text( $footer_text ) {
		...
		if ( sliced_get_the_type() || ( isset( $_GET['page'] ) && strpos( $_GET['page'], 'sliced') ) ) {
			...
			$footer_text = sprintf( __( '...', 'sliced-invoices' ), '<a href="https://wordpress.org/support/plugin/sliced-invoices/reviews/?filter=5#postform" target="_blank" class="">', '</a>' );
	...
	public function client_registration_form() {
		...
		if ( ( $pagenow == 'post.php' || $pagenow == 'post-new.php' ) && ( sliced_get_the_type() ) ) {
			...
			<div id="add-ajax-user" style="display:none">
				...
				<p><span class="description"><?php printf( __( 'B&H (default password: BHC2022@MTL+ )', 'sliced-invoices' ), 'https://slicedinvoices.com/support/clients/' ); ?></span></p>
						...
						<tr class="form-field form-required user-pass1-wrap">
							...
							<td>
								...
								<div class="wp-pwd hide-if-js">
									<?php $initial_password = "BHC2022@MTL+"; ?>
						...
						<tbody>
							...
							<tr class="form-field">
								<th scope="row">
									...
									<textarea class="regular-text" name="_sliced_client_extra_info" placeholder="Worksite:"></textarea></td>
							</tr>
							...
							<tr class="form-field">
								<th scope="row"><label for="url"><?php _e('Website') ?></label></th>
								<td><input name="user_url" type="url" class="code" value="" placeholder="do.tel_" /></td>
							</tr>
