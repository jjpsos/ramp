...
if ( ! function_exists( 'sliced_display_from_address_hdwire' ) ) :

	function sliced_display_from_address_hdwire() { ?>

			<div class="from"><strong><?php echo "Saison 2024/25"; ?></strong></div>
            <div class="from"><strong><?php echo "~~~"; ?></strong></div>
			<div class="wrapper">
			<div class="name"><a target="_blank" href="<?php echo esc_url( sliced_get_business_website() ); ?>"><?php echo esc_html( sliced_get_business_name() ); ?></a></div>
