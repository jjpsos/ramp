 ...
 * Calls the class.
 */
function sliced_call_pdf_invoice_updater_class() {
    return Sliced_Pdf_Invoice_Updater::get_instance();
}
add_action('sliced_loaded', 'sliced_call_pdf_invoice_updater_class', 1);    


class Sliced_Pdf_Invoice_Updater {

	private $store_url   = 'http://slicedinvoices.com';
	private $name        = 'PDF Invoice Extension';
	private $download_id = '2400';
	private $version     = SI_PDF_EMAIL_VERSION;
	private $slug        = 'pdf_invoice';
	private $text_domain = 'sliced-invoices-pdf-email';

	private $key_name    = 'pdf_invoice_license_key';
	private $status_name = 'pdf_invoice_license_status';
	private $error_name  = 'pdf_invoice_license_error';
	...
	public function plugin_updater() {
		// setup the updater
		new Sliced_Plugin_Updater( $this->store_url, SI_PDF_EMAIL_FILE, array(
