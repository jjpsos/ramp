 ...
 * Calls the class.
 */
function sliced_call_easy_translate_updater_class() {
	return Sliced_Easy_Translate_Updater::get_instance();
}
add_action('sliced_loaded', 'sliced_call_easy_translate_updater_class', 1);    


class Sliced_Easy_Translate_Updater {

	private $store_url   = 'http://slicedinvoices.com';
	private $name        = 'Easy Translate Extension';
	private $download_id = '2426';
	private $version     = SI_TRANSLATE_VERSION;
	private $slug        = 'easy_translate';
	private $text_domain = 'sliced-invoices-translate';

	private $key_name    = 'easy_translate_license_key';
	...
	public function plugin_updater() {
		// setup the updater
		new Sliced_Plugin_Updater( $this->store_url, SI_TRANSLATE_FILE, array(
